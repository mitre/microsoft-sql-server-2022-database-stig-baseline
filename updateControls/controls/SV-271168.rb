control 'SV-271168' do
  ...
  desc 'check', "Review the system documentation to determine whether the database is static, the recovery model to be used, the backup schedule, and the plan for testing database restoration.
...
Test the restoration of the database at least once a year; correct any issues that cause it to fail. Maintain a record of these tests.'
  impact 0.5
  tag check_id: 'C-75211r1108118_chk'
  tag severity: 'medium'
  tag gid: 'V-271168'
  tag rid: 'SV-271168r1109218_rule'
  tag stig_id: 'SQLD-22-001500'
