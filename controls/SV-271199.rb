control 'SV-271199' do
  title 'SQL Server must use NSA-approved cryptography to protect classified information in accordance with the data owner’s requirements.'
...
SET ENCRYPTION ON;"
  impact 0.7
  tag check_id: 'C-75242r1108917_chk'
  tag severity: 'high'
  tag gid: 'V-271199'
  tag rid: 'SV-271199r1108919_rule'
  tag stig_id: 'SQLD-22-003200'
