control 'SV-271186' do
  title 'SQL Server must enforce discretionary access control (DAC) policies, as defined by the data owner, over defined subjects and objects.'
...
REVOKE [Permission] ON <Securable> FROM <Principal>'
  impact 0.5
  tag check_id: 'C-75229r1109204_chk'
  tag severity: 'medium'
  tag gid: 'V-271186'
  tag rid: 'SV-271186r1109206_rule'
  tag stig_id: 'SQLD-22-002800'
